---
id: 1
title: "update-translation-system-constitution"
stage: "constitution"
date: "2025-12-30"
surface: "agent"
...
labels: ["constitution", "translation", "i18n"]
links:
  spec: null
  ticket: null
  adr: null
...
files:
  ...
  - ".specify/memory/translation-system-constitution.md"
tests: []
outcome: "Successfully updated the main constitution to include multi-language translation system requirements while preserving existing personalization system requirements."
evaluation: "The constitution now properly covers both the personalization and translation system requirements, ensuring all necessary guidelines are documented for implementation."
---
...
```
I've successfully updated the main constitution file (.specify/memory/constitution.md) to include the multi-language translation system requirements while preserving the existing personalization system requirements. I've also created a separate translation system constitution file (.specify/memory/translation-system-constitution.md) for reference.

The updated constitution now covers:
1. Both personalization and translation system requirements
2. Proper folder structure for i18n support
3. Component implementation guidelines for TranslateButton
4. Docusaurus configuration for multiple languages
5. Translation guidelines and styling consistency
6. Critical rules to preserve existing functionality
7. Testing checklist for both features

The constitution maintains all existing personalization requirements while adding comprehensive guidelines for the multi-language translation system, including Urdu and Hindi support with RTL layout for Urdu.
```